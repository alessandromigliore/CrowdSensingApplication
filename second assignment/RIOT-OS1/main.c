...
//we prepare the values to send in the correct format
        char argomento[200];
        sprintf(argomento, "{\"ts\": %llu, \"values\":{\"temperature\": \"%.2f\", \"humidity\": \"%.2f\", \"windDirection\": \"%.2f\", \"windIntensity\": \"%.2f\", \"rainHeight\": \"%.2f\",\"device\": \"1\"}}", ts, new_temp, new_hum, new_dir, new_inte, new_rain);
