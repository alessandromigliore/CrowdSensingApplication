...
static const uint8_t deveui[LORAMAC_DEVEUI_LEN] = { 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA };
static const uint8_t appeui[LORAMAC_APPEUI_LEN] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x02, 0xD5, 0x25 };
static const uint8_t appkey[LORAMAC_APPKEY_LEN] = { 0xAB, 0xCD, 0x12, 0x34, 0x56, 0x78, 0xEF, 0xDD, 0xDD, 0xDD, 0xDD, 0xDD, 0xDD, 0xDD, 0xDD, 0xDD };
...
static void sender(void)
{
    while (1) {
        ...
        sprintf(message, "{\"humidity\": \"%u.%u\", \"temperature\": \"%u.%u\",\"device\": \"1\"}",
