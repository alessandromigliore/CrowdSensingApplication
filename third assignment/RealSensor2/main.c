...
static const uint8_t deveui[LORAMAC_DEVEUI_LEN] = { 0x00, 0x54, 0x4B, 0x48, 0x54, 0x9D, 0xCE, 0x83 };
static const uint8_t appeui[LORAMAC_APPEUI_LEN] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x02, 0xD5, 0x25 };
static const uint8_t appkey[LORAMAC_APPKEY_LEN] = { 0xB4, 0xCF, 0x3E, 0x9C, 0xA4, 0xCE, 0xEE, 0xA7, 0x38, 0xC4, 0x5A, 0xA3, 0x58, 0xDD, 0x11, 0x8E };
